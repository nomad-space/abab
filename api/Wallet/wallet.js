...
module.exports = (API, redis) => {
    ...
    API.register('wallet', (user, param, callback) => {
    ...
    API.register('requestFunctionContract', (user, param, callback) => {
    ...
    API.register('transfer_coin', (user, param, callback) => {
        // transfer abab_coin
        callback && callback(null, {
    ...
    API.register('callFunctionContract', true, (user, param, callback) => {
